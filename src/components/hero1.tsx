      ...
      <div className='mx-auto w-full max-w-[1920px] px-8 sm:px-20'>
        <div className='grid items-center gap-10 lg:grid-cols-[3fr_2fr]'>
          <div className='order-2 flex flex-col items-center rounded-3xl bg-background/60 p-6 text-center text-foreground shadow-md backdrop-blur-md sm:p-8 lg:order-1 lg:items-start lg:text-left'>
            {badge && (
              <Badge
                className='hero-animate [animation-delay:0s] gap-2 border-0 bg-green-50 py-1.5 text-green-700 dark:bg-green-950/40 dark:text-green-400'>
            ...
            <h1
              className='hero-animate [animation-delay:0.1s] my-6 text-4xl font-bold text-pretty text-foreground lg:text-6xl'>
              {heading}
            </h1>
            <p
              className='hero-animate [animation-delay:0.2s] mb-8 max-w-xl text-foreground/70 lg:text-xl'>
              {description}
            </p>
            <div
              className='hero-animate [animation-delay:0.3s] flex w-full flex-col justify-center gap-2 sm:flex-row lg:justify-start'>
              {buttons.primary && (
            ...
            <dl
              className='hero-animate [animation-delay:0.4s] mt-8 grid w-full max-w-md grid-cols-2 gap-4 text-left text-sm'>
          ...
          <figure
            className='hero-animate [animation-delay:0.2s] order-1 relative mx-auto w-full max-w-[220px] sm:max-w-[260px] lg:order-2 lg:justify-self-end'>
