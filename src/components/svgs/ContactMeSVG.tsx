...
export interface ContactMeSVG {
  classes: { [key: string]: string };
}

export function ContactMeSVG({ classes }: ContactMeSVG) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 790 563' fill='none' className='w-30 h-30'>
      <g id={classes.Image}>
        <g id={classes.g14}>
          <g id={classes.g16}>
            <g id={classes.g22}>
